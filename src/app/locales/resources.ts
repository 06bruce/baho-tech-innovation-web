export const resources = {
  en: {
    translation: {
      ...
      voice: {
        ...
        wakeHint: "Say \"hey activate\" to read the page, or \"hey talker\" to give the AI a command.",
  ...
  rw: {
    translation: {
      ...
      voice: {
        ...
        wakeHint: "Vuga \"hey activate\" kugira ngo AI isome paji, cyangwa \"hey talker\" uyihe ibwiriza.",
  ...
  sw: {
    translation: {
      ...
      voice: { title: "Amri za sauti", start: "Anza amri za sauti", stop: "Acha amri za sauti", available: "Amri zilizopo", unsupported: "Amri za sauti hazitumiki kwenye kivinjari hiki.", wakeHint: "Sema \"hey activate\" ili AI isome ukurasa, au \"hey talker\" kumpa AI amri.", lastHeard: "Iliyosikika mwisho" },
